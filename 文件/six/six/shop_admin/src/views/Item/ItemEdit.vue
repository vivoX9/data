...
<script>
    ...
    export default {
        data () {
      	...
      	let data=this.itemListData.data[this.$route.params.index];
      	this.formValidate=data;
      	this.imgUrl=data.itemImage;
      	//获取参数
        ...
        methods: {
        	...
        	success(res){
        		//图片上传成功的回调
				this.formValidate.itemImage=res;
            ...
            handleSubmit (name) {
                ...
                this.$refs[name].validate((valid) => {
                    if (valid) {
                    Object.assign(this.formValidate,{act:'edit'})	
                    let that=this;
                 	itemApi.edit(this.formValidate).then(res=>{
