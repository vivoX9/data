...
//		var day_bar_dom = '<ul class="calendar_tr calendar_day_bar"></ul>';
	...
	var todaydate = function(){
		...
		console.log([ynow,mnow,dnow])
		return [ynow,mnow,dnow];
		
	}
	console.log(todaydate.ynow)
	//判断是否为闰年
	...
	_this.weekfirstdate = function(year,weeknum){
		...
		console.log([year,startmouch,week_day])
	...
	var setdaydata = function(year,weeknum){
		...
		console.log(datastart[0],datastart[1],datastart[2])
		var trueweeknum = _this.getweeknum(datastart[0],datastart[1],datastart[2]);
		console.log(trueweeknum)
		calendarid.attr({
			"year":trueweeknum[0],
		...
		calendarid.find(".calendar_info").html(todaydate[0]+'周/'+trueweeknum[0]);
...
//		console.log( [weekyear,weeknum_result])
